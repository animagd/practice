...
class LoadingSimplePagesTest(unittest.TestCase):
    ...
    def test_open_page_FAQ(self):
        name_of_page = FAQPage.name_of_page['faq']
    ...
    def test_open_page_eArchiwum(self):
        name_of_page = eArchivesPage.name_of_page['earchiwum']
    ...
    def test_open_page_Dokumenty(self):
        name_of_page = DocumentsPage.name_of_page['documents']
    ...
    def test_open_page_Kontakt(self):
        name_of_page = ContactPage.name_of_page['contact']
